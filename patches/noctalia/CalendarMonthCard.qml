      ...
      GridLayout {
        ...
        Repeater {
          ...
          Item {
            ...
            Rectangle {
              width: Style.baseWidgetSize * 0.8
              height: Style.baseWidgetSize * 0.8
              anchors.centerIn: parent
              ...
              Row {
                ...
                Repeater {
                  model: parent.parent.parent.parent.parent.getEventsForDate(modelData.year, modelData.month, modelData.day).slice(0, 3)
