...
PACKAGES=(nvim kitty tmux tms zsh starship fontconfig direnv nix niri noctalia claude gtk fcitx5 yazi webapps voice translate walker zathura pencil mise vdirsyncer wireplumber pipewire ssh)
