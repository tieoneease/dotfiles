...
PACKAGES=(nvim kitty tmux tms zsh starship fontconfig direnv nix niri noctalia claude gtk fcitx5 yazi webapps voice walker zathura pencil mise vdirsyncer wireplumber)
